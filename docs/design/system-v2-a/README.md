...
> OCL-115. Uma linguagem visual unificada para o OverClick (web board) e o Overclock IDE (app multi-pane). Codinome interno: **Aero-Mono**.
...
- **OverClick web** — o board de cards (mission control).
...
| Conceito | Web (OverClick board) | App (Overclock IDE) | Token compartilhado |
|---|---|---|---|
...
- OverClick UX v2 (`docs/design/ux-v2.md`) — direção base e kill list.
- OverClick design system OCL-81 (`docs/design/system/`) — base a superar.
